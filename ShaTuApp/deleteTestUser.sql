...
# Created: Jan 11, 2025
#
# Eventually, this script will be useless since it's a very heavy hammer
# which cleans up the 'test@regis.edu' user, but also all assessment data
# for every student account. It's usefulness is that it leaves static
