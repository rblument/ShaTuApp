...
public class EncodeView extends UserRequestView {
     ...
     * JTextField's where users can specify the length of the message they want
     * to encode and/or set their own custom question.
     */
    ...
    /**
     * Creates and returns a JPanel dedicated to setting the message length and
     * custom question.
     *
