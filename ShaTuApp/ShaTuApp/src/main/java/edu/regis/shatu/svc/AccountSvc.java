...
public interface AccountSvc extends CRUD<Account> {
        ...
        // * @throws NonRecoverableException also see getCause().getErrorCode().
        // */
        // Account retrieve(String userId) throws ObjNotFoundException,
        // NonRecoverableException;
